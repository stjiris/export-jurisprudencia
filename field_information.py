...
name_to_original_getter = {
    ...
    'Jurisprudência Estrangeira': lambda o: text_content(o["Jurisprudência Estrangeira.raw"]) if "Jurisprudência Estrangeira" in o else "",
    'Jurisprudência Internacional': lambda o: text_content(o["Jurisprudência Internacional.raw"]) if "Jurisprudência Internacional" in o else "",
    'Doutrina': lambda o: text_content(o["Doutrina.raw"]) if "Doutrina" in o else "",
    'Jurisprudência Nacional': lambda o: text_content(o["Jurisprudência Nacional.raw"]) if "Jurisprudência Nacional" in o else "",
    'Legislação Comunitária': lambda o: text_content(o["Legislação Comunitária.raw"]) if "Legislação Comunitária" in o else "",
    'Legislação Estrangeira': lambda o: text_content(o["Legislação Estrangeira.raw"]) if "Legislação Estrangeira" in o else "",
    'Legislação Nacional': lambda o: text_content(o["Legislação Nacional.raw"]) if "Legislação Nacional" in o else "",
    'Referências Internacionais': lambda o: text_content(o["Referências Internacionais.raw"]) if "Referências Internacionais" in o else "",
    'Indicações Eventuais': lambda o: text_content(o["Indicações Eventuais.raw"]) if "Indicações Eventuais" in o else "",
